...
import { Button, FlatList, ImageBackground, SafeAreaView, StyleSheet, Text, View } from 'react-native';
...
const Home = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ImageBackground source={require('./blueFillerBackground.png')} style={styles.background}>
        <FlatList
          ListHeaderComponent={() => (
        ...
        />
         <View style={styles.buttonContainer}>
          <Button title="Todays Events" onPress={toggleEvents}/>
        </View>
      </ImageBackground>
    </SafeAreaView>
  );
